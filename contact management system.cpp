#include <iostream>
#include <conio.h>      //refresh the screen or erase the screen
#include <fstream>      //use a file system so we need f stream

using namespace std;


class contact           //we're creating a contact management system so we have to score the record of contact for a person
{
private:                //some data numbers and make them private
    char fName[50], lName[50], address[50], email[50];
    long long phNo;

public:
    void createContact()       //read data from user..we need to create function so that we can read data from the user and store data in this variable also we want to display
    {                                //these data ,we make function public
    ...
    void showContact()   //let's call that function
    {
    ...
    void writeOnFile()   //a function that save data in the file
    {
        char ch;
        ofstream f1;
